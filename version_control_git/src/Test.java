...
public class Test {
    ...
    public static void testCommit(String path) throws Exception{
        Commit commit1 = new Commit("2th_group","2th_group","first commit");
        ...
        printWriter.close();
        Commit commit2 = new Commit("2th_group","2th_group","second commit");
        System.out.println(commit2.getValue());
        commit2.write();
